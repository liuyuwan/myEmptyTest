...
<div id="content"><?php echo $content_top; ?>
  ...
  <div class="product-info">
    ...
    <div class="col-lg-6 col-md-6">
      ...
      <div class="description">
		...
		<?php if(strcasecmp($mpn,'Special')!=0){  ?>  
	    <?php if ($price) { ?>
  ...
  <?php } ?>
   ...
   <?php } ?> 
      ...
      <?php if ($products && 1==2) { // disabled by Roy as we are using a side module for related products ?>
  <?php 
   ...
   <div id="related" class="slide product-grid" data-interval="0">
    ...
    <div class="box-content products-block carousel-inner">
        ...
        <div class="image">
          ...
          <a href="<?php echo $zimage;?>" class="related-colorbox product-zoom hidden-sm hidden-xs" rel="nofollow" title="<?php echo $product['name']; ?>"><span class="icon-zoom-in"></span></a>
          <?php } ?>
